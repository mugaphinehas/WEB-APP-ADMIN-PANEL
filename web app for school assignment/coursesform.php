...
if (isset($_POST['submit'])) {
    $student_ID = $_POST['courseID'];
    $studentName = $_POST['courseName'];
    $studentAddress = $_POST['coursetype'];
    $studentCourse = $_POST['courseinstructor'];

    $sql = "INSERT INTO `courses` (`course_ID`, `course Name`, `course type`, `course instructor`) 
